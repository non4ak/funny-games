...
export default function CreateGameModal({show, onClose, onSubmit}) {
    ...
    return (
        <div className="fixed inset-0 bg-black/5 backdrop-blur-md/15 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-12 w-[500px] max-w-md shadow-lg relative flex flex-col gap-8 -translate-y-[100px]">
                ...
                <div className="flex justify-center gap-4 text-xl font-semibold ">
                    ...
                    <button className="border-2 border-gray-300 py-2.5 px-3s w-[150px] cursor-pointer hover:bg-red-500 hover:text-white uppercase" onClick={onClose}>Cancel</button>
                </div>
            </div>
        </div>  
    )
