    ...
    return (
        <>
            <div className='w-full h-screen bg-gray-100 '>
                <NavBar />
                <h1 className='text-[3.5rem] text-center py-2 font-medium'>Wordle</h1>
                ...
                <div className='flex flex-col w-[500px] mx-auto mt-8 items-center justify-center'>
                    ...
                    <button
                        ...
                        className={`text-2xl mt-4 w-[200px] py-2.5 rounded-2xl button-submit cursor-pointer ${isShaking ? "shake" : ""}`}
                    >
                        Submit
                    </button>       
                </div>
